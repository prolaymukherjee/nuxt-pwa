...
const layouts = {
  default: () => import('./default-3dc27446.mjs').then((m) => m.default || m),
  products: () => import('./products-e679f739.mjs').then((m) => m.default || m)
};
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./about-5a5062d1.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-e337d6fe.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_id_-485117fe.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-b1d37217.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-ae6c6a2f.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-0d4cca4f.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
