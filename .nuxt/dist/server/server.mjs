import { reactive, getCurrentInstance, toRef, isRef, inject, version, ref, watchEffect, watch, unref, h, defineComponent, computed, Transition, Suspense, nextTick, provide, shallowRef, isReadonly, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const layouts = {
  default: () => import("./_nuxt/default-3dc27446.js").then((m) => m.default || m),
  products: () => import("./_nuxt/products-e679f739.js").then((m) => m.default || m)
};
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-5a5062d1.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e337d6fe.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_id_-485117fe.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-b1d37217.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-ae6c6a2f.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-0d4cca4f.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
