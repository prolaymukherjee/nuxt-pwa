declare global {
  const __buildAssetsURL: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useAppConfig: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('/opt/lampp/htdocs/exprement/nuxt-test/node_modules/nitropack/dist/runtime')['useStorage']
